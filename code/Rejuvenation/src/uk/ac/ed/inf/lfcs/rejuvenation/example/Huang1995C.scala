...
object Huang1995CTest extends App{
  val worker = new Worker(2 * 7 * 24 * 6, Huang1995C.failure_repair, Huang1995C.rejeneation_time, Huang1995C.constantPMF)
//  worker.report_ptm  
...
//    var out = System.out     
  ...
  worker.simulate(startStates, 1 * worker.full_period + 3, out)    
}
